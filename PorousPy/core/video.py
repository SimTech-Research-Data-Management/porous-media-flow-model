...
class Video(sdRDM.DataModel):
    ...
    id: str = Field(description='Unique identifier of the given object.', default_factory=IDGenerator('videoINDEX'), xml='@id')
    ...
    total_frames: Optional[int] = Field(description='Number of frames found in this video', default=None)


    frames: Union[NDArray, H5Dataset, None] = Field(description='Videoframes', default=None)


    __repo__: Optional[str] = PrivateAttr(default='git://github.com/SimTech-Research-Data-Management/porous-media-flow-model.git')


    __commit__: Optional[str] = PrivateAttr(default='53d30eba563d0bc6bcf3db15575fa61d02387eb0')
